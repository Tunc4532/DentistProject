    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCards", x => x.CategoryCardId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServicePromotionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SliderCardId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Icon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Hour1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Hour2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Hour3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderCards", x => x.SliderCardId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppointmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientTcKimlik = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProcedureLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppointmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureLogs", x => x.ProcedureLogId);
                    table.ForeignKey(
                        name: "FK_ProcedureLogs_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcedureLogs_AppointmentId",
                table: "ProcedureLogs",
